...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/leotvgo/danmu_api&project-name=danmu_api&repository-name=danmu_api)
...
<a href="https://app.netlify.com/start/deploy?repository=https://github.com/leotvgo/danmu_api"><img src="https://www.netlify.com/img/deploy/button.svg"></a>
...
### 一键部署
[![使用 EdgeOne Pages 部署](https://cdnstatic.tencentcs.com/edgeone/pages/deploy.svg)](https://console.cloud.tencent.com/edgeone/pages/new?template=https://github.com/leotvgo/danmu_api&project-name=danmu-api&root-directory=.%2F&env=TOKEN)
...
> 
> 也可直接用国际站的部署按钮一键部署，默认选择"全球可用区（不含中国大陆）" [![使用 EdgeOne Pages 部署](https://cdnstatic.tencentcs.com/edgeone/pages/deploy.svg)](https://edgeone.ai/pages/new?template=https://github.com/leotvgo/danmu_api&project-name=danmu-api&root-directory=.%2F&env=TOKEN)
> 
...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/leotvgo/danmu_api)
